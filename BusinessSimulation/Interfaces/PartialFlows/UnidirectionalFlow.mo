...
initial equation
  ...
  pre(useA_rate) = Functions.constrainedRateBoolean(A_rate, portA.stopInflow, portA.stopOutflow) and A_rate > 0;
...
equation
  ...
  useA_rate = Functions.constrainedRateBoolean(A_rate, portA.stopInflow, portA.stopOutflow) and A_rate > 0;
