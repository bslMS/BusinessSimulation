...
partial model BasicActuator "Partial actuator subsystem model (no stock ports)"
  extends Icons.SubsystemActuator;
  extends BaseSubsystem(final n_stockPorts = 0);
...
<p>This class extends the →<a href=\"modelica://BusinessSimulation.Interfaces.PartialSubsystems.BaseSubsystem\"><code>BaseSubsystem</code></a> and the →<a href=\"modelica://BusinessSimulation.Icons.SubsystemActuator\"><code>Icons.SubsystemActuator</code></a> classes. By modifying the constant <code>iconLabel</code> a label in a color matching the subsystem type can be given. An <em>actuator</em> subsystem cannot have stock ports.</p>
<h4>Notes</h4>
