...
encapsulated partial class OutputTypeChoice_Rate "Partial model to set the output type to some kind of rate"
  ...
  replaceable type OutputType = Unspecified constrainedby Rate "Type choice" annotation(choicesAllMatching = true);
  connector RealOutput = output OutputType "Output rate signal" annotation(defaultComponentName = "y",IconMap(primitivesVisible = false), Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, initialScale = 0.1, grid = {10, 10}), graphics = {Polygon(visible = true, lineColor = {1, 37, 163}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{-100, 100}, {100, 0}, {-100, -100}})}), Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, initialScale = 0.1, grid = {10, 10}), graphics = {Polygon(visible = true, lineColor = {1, 37, 163}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{-100, 50}, {0, 0}, {-100, -50}}), Text(visible = true, origin = {0, 80}, textColor = {128, 128, 128}, extent = {{-100, -12}, {100, 12}}, textString = "%name", fontName = "Lato", textStyle = {TextStyle.Bold})}), Documentation(info = "<html>
...
<li>Added <code>choicesAllmatching = true</code> in v2.1.0, which makes list of <code>choices</code> unnecessary.</li>
</ul>
