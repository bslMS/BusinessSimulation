...
partial block BaseInformationProcessing "Basic information processing class"
  extends Icons.InformationProcessing;
  extends OutputTypeChoice;
  annotation(Documentation(info = "<html>
<p class=\"aside\">This information is part of the Business Simulation&nbsp;Library (BSL).</p>
<p>Partial block extending from Icons.InformationProcessing and &rarr;<a href=\"modelica://BusinessSimulation.Interfaces.Basics.OutputTypeChoice\">OutputTypeChoice</a>. This is the base class for InformationProcessing-related components.</p>
<h4>See also</h4>
