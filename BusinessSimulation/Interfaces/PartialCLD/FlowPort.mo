...
encapsulated partial model FlowPort "Single flow port with optional flow reporting"
  ...
  RealOutput y(quantity = "Rate", unit = "1/s") if hasRateOutput "Output of current rate of flow" annotation(Placement(visible = true, transformation(origin = {161.845, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {50, 30}, extent = {{-10, -10}, {10, 10}}, rotation = -270)));
  RealOutput y1(quantity = "Rate", unit = "1/s") if hasRateOutput "Output of current rate of flow" annotation(Placement(visible = true, transformation(origin = {162.083, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {50, -30}, extent = {{-10, 10}, {10, -10}}, rotation = 270)));
