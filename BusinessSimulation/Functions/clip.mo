...
<h4>Notes</h4>
<p>This function is closely modeled to <a href=\"https://reference.wolfram.com/language/ref/Clip.html\"><code>Clip</code></a>&nbsp;in the Wolfram Languag<em>e</em>.</p></html>", revisions = ""));
end clip;
