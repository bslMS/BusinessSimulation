...
package Flows "Processes that move entities from one stock to another at a specific rate"
  extends Icons.Package;
  annotation(Documentation(info = "<html>
<p class=\"aside\">This information is part of the Business Simulation&nbsp;Library (BSL).</p>
<p>This package contains flow elements of the System Dynamics method.</p>
<h4>See also</h4>
<p>
