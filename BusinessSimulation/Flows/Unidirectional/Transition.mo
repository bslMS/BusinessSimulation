...
model Transition "Flow from stock A to stock B at a given rate"
  ...
  parameter OutputType rate(min = 0) = unspecified "Constant rate of transition (optional)" annotation(Dialog(enable = hasConstantRate));
