...
model PID_Control "Directly influencing a stock to keep it at setpoint value"
  ...
  import BusinessSimulation.Units.{Time,Fraction};
...
protected
  replaceable type GainType = Reals "Type choice for controller gain" annotation(choices(choice(redeclare type GainType = .BusinessSimulation.Units.Information "Information [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.Fraction "Fraction [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.Dimensionless "Dimensionless [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.Probability "Probability [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.Amount "Amount [each]"), choice(redeclare type GainType = .BusinessSimulation.Units.Money "Money [CU]"), choice(redeclare type GainType = .BusinessSimulation.Units.Money_USD "Money [USD]"), choice(redeclare type GainType = .BusinessSimulation.Units.Money_EUR "Money [EUR]"), choice(redeclare type GainType = .BusinessSimulation.Units.Money_JPY "Money [JPY]"), choice(redeclare type GainType = .BusinessSimulation.Units.Money_GBP "Money [GBP]"), choice(redeclare type GainType = .BusinessSimulation.Units.Population "Population [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.People "People [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.Labor "Labor [FTE]"), choice(redeclare type GainType = .BusinessSimulation.Units.TangibleAssets "Tangible assets [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.IntangibleAssets "Intangible assets [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.Material "Material [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.Goods "Goods [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.Orders "Orders [1]"), choice(redeclare type GainType = .BusinessSimulation.Units.Volume "Volume [m3]"), choice(redeclare type GainType = .BusinessSimulation.Units.Mass "Mass [kg]"), choice(redeclare type GainType = .BusinessSimulation.Units.Energy "Energy [J]"), choice(redeclare type GainType = .BusinessSimulation.Units.Momentum "Momentum [kg.m/s]"), choice(redeclare type GainType = .BusinessSimulation.Units.AngularMomentum "Angular momentum [kg.m2/s]"), choice(redeclare type GainType = .BusinessSimulation.Units.Angle "Angle [rad]"), choice(redeclare type GainType = .BusinessSimulation.Units.Length "Length [m]"), choice(redeclare type GainType = .BusinessSimulation.Units.Area "Area [m2]"), choice(redeclare type GainType = .BusinessSimulation.Units.Time "Time [s]"), choice(redeclare type GainType = .BusinessSimulation.Units.Time_minutes "Time [min]"), choice(redeclare type GainType = .BusinessSimulation.Units.Time_hours "Time [h]"), choice(redeclare type GainType = .BusinessSimulation.Units.Time_days "Time [d]"), choice(redeclare type GainType = .BusinessSimulation.Units.Time_weeks "Time [wk]"), choice(redeclare type GainType = .BusinessSimulation.Units.Time_months "Time [mo]"), choice(redeclare type GainType = .BusinessSimulation.Units.Time_quarters "Time [qtr]"), choice(redeclare type GainType = .BusinessSimulation.Units.Time_years "Time [yr]"), choice(redeclare type GainType = .BusinessSimulation.Units.Rate "Rate [1/s]"), choice(redeclare type GainType = .BusinessSimulation.Units.AmountRate "Amount rate [each/s]"), choice(redeclare type GainType = .BusinessSimulation.Units.VolumeFlowRate "Volume flow rate [m3/s]"), choice(redeclare type GainType = .BusinessSimulation.Units.MassFlowRate "Mass flow rate [kg/s]"), choice(redeclare type GainType = .BusinessSimulation.Units.EnergyFlowRate "Energy flow rate [J/s]"), choice(redeclare type GainType = .BusinessSimulation.Units.MomentumFlowRate "Momentum flow rate [kg.m/s2]"), choice(redeclare type GainType = .BusinessSimulation.Units.AngularMomentumFlowRate "Angular momentum flow rate [kg.m2/s2]"), choice(redeclare type GainType = .BusinessSimulation.Units.Velocity "Velocity [m/s]")));
