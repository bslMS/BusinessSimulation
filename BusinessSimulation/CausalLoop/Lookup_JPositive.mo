...
protected
  Converters.Lookup.JanoschekPositive lookup(lowerBound = lowerBound, upperBound = upperBound, growthRate = growthRate, x_ref = x_ref, y_ref = y_ref, redeclare replaceable type OutputType = Units.Dimensionless) annotation(Placement(visible = true, transformation(origin = {0, -0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
