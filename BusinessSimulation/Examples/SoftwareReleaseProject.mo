...
model SoftwareReleaseProject "Causal loop example given by van Zijderveld (MARVEL)"
  ...
  inner ModelSettings modelSettings(modelTimeHorizon(displayUnit = "yrCal") = 315569520, dt(displayUnit = "yrCal") = 7889238, modelDisplayTimeBase = BusinessSimulation.Types.TimeBases.years, samplingPeriod.displayUnit = "yrCal") annotation(Placement(visible = true, transformation(origin = {-130, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  parameter Time v4(displayUnit = "yrCal") = 7889238 "Very high speed" annotation(Dialog(group = "Speed of Influence"));
  parameter Time v3(displayUnit = "yrCal") = 15778476 "High speed" annotation(Dialog(group = "Speed of Influence"));
  parameter Time v2(displayUnit = "yrCal") = 31556952 "Average speed" annotation(Dialog(group = "Speed of Influence"));
  parameter Time v1(displayUnit = "yrCal") = 94670856 "Low speed" annotation(Dialog(group = "Speed of Influence"));
...
protected
  ...
  // relations (impact)
  CausalLoop.ProportionalityDelayed r1(factor = +wk, delayTime(displayUnit = "yrCal") = v1) "External resrouces >> clear mandate" annotation(Placement(visible = true, transformation(origin = {-135, 5}, extent = {{-10, 10}, {10, -10}}, rotation = 270)));
  CausalLoop.ProportionalityDelayed r2(factor = +wk, delayTime(displayUnit = "yrCal") = v2) "External resources >> management knowledge level" annotation(Placement(visible = true, transformation(origin = {-64, 7}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r3(factor = +av, delayTime(displayUnit = "yrCal") = v2) "External resources >> management quality" annotation(Placement(visible = true, transformation(origin = {-30, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r4(factor = +av, delayTime(displayUnit = "yrCal") = v3) "External resources >> software management organization capacity" annotation(Placement(visible = true, transformation(origin = {-63, 17}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r5(factor = +st, delayTime(displayUnit = "yrCal") = v3, hasRateOutput = false) "Budget >> external resources" annotation(Placement(visible = true, transformation(origin = {-100, 55}, extent = {{10, 10}, {-10, -10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r6(factor = -st, delayTime(displayUnit = "yrCal") = v3) "Clear mandate >> number of parties involved" annotation(Placement(visible = true, transformation(origin = {-118, -35}, extent = {{10, 10}, {-10, -10}}, rotation = -270)));
  CausalLoop.ProportionalityDelayed r7(factor = -vs, delayTime(displayUnit = "yrCal") = v3) "Costs >> cost effectiveness" annotation(Placement(visible = true, transformation(origin = {82.503, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r8(factor = +vs, delayTime(displayUnit = "yrCal") = v3) "Decision quality >> design quality" annotation(Placement(visible = true, transformation(origin = {-10, -40}, extent = {{-10, 10}, {10, -10}}, rotation = -90)));
  CausalLoop.ProportionalityDelayed r9(factor = -av, delayTime(displayUnit = "yrCal") = v2) "Decision speed >> number of ad hoc design decisions" annotation(Placement(visible = true, transformation(origin = {-65, -35}, extent = {{10, 10}, {-10, -10}}, rotation = 90)));
  CausalLoop.ProportionalityDelayed r10(factor = +av, delayTime(displayUnit = "yrCal") = v2) "Design quality >> software quality" annotation(Placement(visible = true, transformation(origin = {15, -40}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r11(factor = +st, delayTime(displayUnit = "yrCal") = v4) "Management knowledge level >> decision quality" annotation(Placement(visible = true, transformation(origin = {-30, -15}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  CausalLoop.ProportionalityDelayed r12(factor = -wk, delayTime(displayUnit = "yrCal") = v2) "Management quality >> resistance against software" annotation(Placement(visible = true, transformation(origin = {50, -5.412}, extent = {{10, 10}, {-10, -10}}, rotation = 90)));
  CausalLoop.ProportionalityDelayed r13(factor = +wk, delayTime(displayUnit = "yrCal") = v2) "Management quality >> software usage" annotation(Placement(visible = true, transformation(origin = {72.552, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r14(factor = +av, delayTime(displayUnit = "yrCal") = v2) "Change pressure >> budget" annotation(Placement(visible = true, transformation(origin = {-10, 45}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r15(factor = -av, delayTime(displayUnit = "yrCal") = v4) "Number of ad hoc design decisions >> design quality" annotation(Placement(visible = true, transformation(origin = {-25, -60}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r16(factor = +av, delayTime(displayUnit = "yrCal") = v4) "Number of employees >> costs" annotation(Placement(visible = true, transformation(origin = {33, 15}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r17(factor = -wk, delayTime(displayUnit = "yrCal") = v2) "Number of employees >> resistance against software" annotation(Placement(visible = true, transformation(origin = {28, -7.49}, extent = {{10, 10}, {-10, -10}}, rotation = 90)));
  CausalLoop.ProportionalityDelayed r18(factor = -av, delayTime(displayUnit = "yrCal") = v3) "Number of parties involved >> decision speed" annotation(Placement(visible = true, transformation(origin = {-105, -20}, extent = {{-10, -10}, {10, 10}}, rotation = -270)));
  CausalLoop.ProportionalityDelayed r19(factor = -av, delayTime(displayUnit = "yrCal") = v2) "Production efficiency >> costs" annotation(Placement(visible = true, transformation(origin = {80, 15}, extent = {{10, 10}, {-10, -10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r20(factor = +av, delayTime(displayUnit = "yrCal") = v3) "Production quality >> cost effectiveness" annotation(Placement(visible = true, transformation(origin = {123.248, 5}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  CausalLoop.ProportionalityDelayed r21(factor = +vs, delayTime(displayUnit = "yrCal") = v4) "Software acceptance >> software usage" annotation(Placement(visible = true, transformation(origin = {80, -55}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r22(factor = -av, delayTime(displayUnit = "yrCal") = v3) "Number of parties involved >> design quality" annotation(Placement(visible = true, transformation(origin = {-64, -70}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r23(factor = +wk, delayTime(displayUnit = "yrCal") = v1) "Software management organization capacity >> software quality" annotation(Placement(visible = true, transformation(origin = {-3.016, -10}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  CausalLoop.ProportionalityDelayed r24(factor = +av, delayTime(displayUnit = "yrCal") = v2) "Software quality >> software acceptance" annotation(Placement(visible = true, transformation(origin = {40, -65}, extent = {{10, 10}, {-10, -10}}, rotation = -270)));
  CausalLoop.ProportionalityDelayed r25(factor = -wk, delayTime(displayUnit = "yrCal") = v2) "Software usage >> number of employees" annotation(Placement(visible = true, transformation(origin = {65, -27.118}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r26(factor = +av, delayTime(displayUnit = "yrCal") = v3) "Software usage >> productive efficiency" annotation(Placement(visible = true, transformation(origin = {85, -5}, extent = {{10, -10}, {-10, 10}}, rotation = -90)));
  CausalLoop.ProportionalityDelayed r27(factor = +av, delayTime(displayUnit = "yrCal") = v3) "Software usage >> production quality" annotation(Placement(visible = true, transformation(origin = {115, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r28(factor = -st, delayTime(displayUnit = "yrCal") = v2) "Production quality >> change pressure" annotation(Placement(visible = true, transformation(origin = {135, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  CausalLoop.ProportionalityDelayed r29(factor = -wk, delayTime(displayUnit = "yrCal") = v4) "Software usage >> resistance against software" annotation(Placement(visible = true, transformation(origin = {63, -15}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  CausalLoop.ProportionalityDelayed r30(factor = -st, delayTime(displayUnit = "yrCal") = v4) "resistance against software >> software acceptance" annotation(Placement(visible = true, transformation(origin = {50, -55}, extent = {{10, 10}, {-10, -10}}, rotation = -270)));
  CausalLoop.ProportionalityDelayed r31(factor = +av, delayTime(displayUnit = "yrCal") = v4) "Software management organization capacity >> number of employees" annotation(Placement(visible = true, transformation(origin = {8.076, 7.13}, extent = {{10, -10}, {-10, 10}}, rotation = 90)));
  // interventions (e.g., control)
  CausalLoop.SimpleControl c1(initialSetpoint = 0.8, finalSetpoint = 0.8, duration(displayUnit = "yrCal") = 315360000, adjTime(displayUnit = "yrCal") = 31536000) if c1ActiveQ annotation(Placement(visible = true, transformation(origin = {-90, 45}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.SimpleControl c2(initialSetpoint = 0.7, finalSetpoint = 0.7, duration(displayUnit = "yrCal") = 315360000, adjTime(displayUnit = "yrCal") = 31536000, hasRateOutput = false) if c2ActiveQ annotation(Placement(visible = true, transformation(origin = {-135, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.SimpleControl c3(initialSetpoint = 0.5, finalSetpoint = 0.5, duration(displayUnit = "yrCal") = 315360000, adjTime(displayUnit = "yrCal") = 31536000, hasRateOutput = false) if c3ActiveQ annotation(Placement(visible = true, transformation(origin = {-45, -12.32}, extent = {{-10, -10}, {10, 10}}, rotation = -270)));
  CausalLoop.SimpleControl c4(initialSetpoint = 0.6, finalSetpoint = 0.6, duration(displayUnit = "yrCal") = 315360000, adjTime(displayUnit = "yrCal") = 31536000) if c4ActiveQ annotation(Placement(visible = true, transformation(origin = {21.696, 35}, extent = {{-10, 10}, {10, -10}}, rotation = 360)));
...
equation
  ...
  annotation(preferredView = "diagram", experiment(StopTime = 315569520, __Wolfram_DisplayTimeUnit = "yrCal", __Wolfram_NumberOfIntervals = -1), Documentation(revisions = "<html>
<ul>
