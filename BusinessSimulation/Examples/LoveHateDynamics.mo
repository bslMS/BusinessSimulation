...
</html>"), Diagram(coordinateSystem(extent = {{-148.5, -105}, {148.5, 105}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5}), graphics = {Text(visible = true, origin = {0, 80}, textColor = {76, 112, 136}, extent = {{-140, -6}, {140, 6}}, textString = "Dynamics of Love and Hate", fontName = "Lato Black"), Bitmap(visible = true, origin = {18.067, 26.507}, fileName = "modelica://BusinessSimulation/Resources/Images/Examples/LoveHateDynamics/Heart.svg", imageSource = "", extent = {{-16.933, -13.493}, {16.933, 13.493}}), Bitmap(visible = true, origin = {-50, 26.507}, fileName = "modelica://BusinessSimulation/Resources/Images/Examples/LoveHateDynamics/Man.svg", imageSource = "", extent = {{-16.933, -13.493}, {16.933, 13.493}}), Bitmap(visible = true, origin = {50, 26.507}, fileName = "modelica://BusinessSimulation/Resources/Images/Examples/LoveHateDynamics/Woman.svg", imageSource = "", extent = {{-16.933, -13.493}, {16.933, 13.493}}), Bitmap(visible = true, origin = {-15, 26.507}, fileName = "modelica://BusinessSimulation/Resources/Images/Examples/LoveHateDynamics/HeartBroken.svg", imageSource = "", extent = {{-16.933, -13.493}, {16.933, 13.493}}), Text(visible = true, origin = {0, 70}, textColor = {76, 112, 136}, extent = {{-140, -3}, {140, 3}}, textString = "Steven H. Strogatz [16]", fontName = "Lato", textStyle = {TextStyle.Bold})}), __Wolfram, experiment(StartTime = 0, StopTime = 10));
