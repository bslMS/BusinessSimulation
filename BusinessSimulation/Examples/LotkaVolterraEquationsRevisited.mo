...
model LotkaVolterraEquationsRevisited "Predator-prey dynamics with an additional predator"
  ...
  expandable connector ModelOutput "Main output of the model"
    ...
    Population wolves(unit = "wolves") "Wolf population";
  ...
  model Theta "Parameter definitions for the Base Case"
    ...
    parameter Population IRA(unit = "rabbits") = 25 "Initial rabbit population";
    parameter Population IFO(unit = "foxes") = 2 "Initial fox population";
    parameter Population IWO(unit = "wolves") = 4 "Initial wolf population";
    // rates
...
protected
  Stocks.MaterialStock rabbits(initialValue = theta.IRA) "Population of rabbits" annotation(Placement(visible = true, transformation(origin = {-70, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Stocks.MaterialStock foxes(initialValue = theta.IFO) "Population of foxes" annotation(Placement(visible = true, transformation(origin = {10, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Stocks.MaterialStock wolves(initialValue = theta.IWO) "Population of wolves" annotation(Placement(visible = true, transformation(origin = {60, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  SourcesOrSinks.ExponentialGrowth reproduction(fractionalRate = theta.rabbitsReproRate, hasConstantRate = true) annotation(Placement(visible = true, transformation(origin = {-110, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
<table cellspacing=\"0\" cellpadding=\"2\"><caption align=\"bottom\">Simulation Results</caption>
<tbody>
<tr>
