...
model LotkaVolterraSystems "Predator-prey dynamics"
  ...
  parameter Rate alpha(displayUnit = "1/yrCal") = 3.16887385068114e-09 "Reproduction rate of prey";
  parameter Rate beta(displayUnit = "1/yrCal") = 6.33774770136229e-10 "Mortality rate of prey per predator";
  parameter Rate gamma(displayUnit = "1/yrCal") = 1.26754954027246e-08 "Mortality rate of predator";
  parameter Rate delta(displayUnit = "1/yrCal") = 6.33774770136229e-10 "Reproduction rate of predators per prey";
  inner ModelSettings modelSettings(modelDisplayTimeBase = BusinessSimulation.Types.TimeBases.years, dt(displayUnit = "yrCal") = 7889238, modelTimeHorizon(displayUnit = "yrCal") = 3155695200) annotation(Placement(visible = true, transformation(origin = {-110, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
