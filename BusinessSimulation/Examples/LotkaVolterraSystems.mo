...
model LotkaVolterraSystems "Predator-prey dynamics"
  ...
  expandable connector ModelOutput
    ...
    Population rabbits(unit = "rabbits") "Rabbit population";
    Population foxes(unit = "foxes") "Fox population";
    Population prey "Prey population";
    Population predators "Predator population";
  end ModelOutput;
protected
  Stocks.MaterialStock prey(initialValue = 10, init = BusinessSimulation.Types.InitializationOptions.FixedValue, redeclare replaceable type OutputType = Units.Population) annotation(Placement(visible = true, transformation(origin = {-50, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Stocks.MaterialStock predators(initialValue = 10, init = BusinessSimulation.Types.InitializationOptions.FixedValue, redeclare replaceable type OutputType = Units.Population) annotation(Placement(visible = true, transformation(origin = {30, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Stocks.MaterialStock rabbits(initialValue = 10, init = BusinessSimulation.Types.InitializationOptions.FixedValue, redeclare replaceable type OutputType = Units.Population(unit = "rabbits")) annotation(Placement(visible = true, transformation(origin = {-50, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Stocks.MaterialStock foxes(initialValue = 10, init = BusinessSimulation.Types.InitializationOptions.FixedValue, redeclare replaceable type OutputType = Units.Population(unit = "foxes")) annotation(Placement(visible = true, transformation(origin = {30, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  SourcesOrSinks.ExponentialGrowth reproducing(fractionalRate = alpha, hasConstantRate = true) annotation(Placement(visible = true, transformation(origin = {-90, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
<table cellspacing=\"0\" cellpadding=\"2\"><caption align=\"bottom\">Simulaton Results</caption>
<tbody>
<tr>
