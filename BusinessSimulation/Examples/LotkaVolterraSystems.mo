...
protected
  ...
  Flows.Interaction.NonlinearInteraction predation(hasConstantFactorA = true, hasConstantFactorB = true, a_AB = -beta, b_AB = delta, redeclare replaceable type OutputType_A = AmountRate, redeclare replaceable type OutputType_B = AmountRate) "Foxes predating on rabbits" annotation(Placement(visible = true, transformation(origin = {-10, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Flows.Interaction.LotkaVolterra predating(hasConstantAlpha = true, hasConstantBeta = true, hasConstantGamma = true, hasConstantDelta = true, alpha = alpha, beta = beta, delta = delta, gamma = gamma, redeclare replaceable type OutputType_A = AmountRate, redeclare replaceable type OutputType_B = AmountRate, redeclare replaceable type TypeA = Amount, redeclare replaceable type TypeB = Amount) "Compact interaction flow that combines all processes of growth and decline" annotation(Placement(visible = true, transformation(origin = {-10, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
public
equation
  ...
  annotation(
    ...
    Diagram(graphics = {Text(origin = {0, 80}, textColor = {76, 112, 136}, extent = {{-140, -6}, {140, 6}}, textString = "Lotka-Volterra Systems", fontName = "Lato"), Text(origin = {0, 70}, textColor = {76, 112, 136}, extent = {{-140, -3}, {140, 3}}, textString = "Example given by Michael Tiller in 'Modelica by Example'", fontName = "Lato", textStyle = {TextStyle.Bold}), Text(origin = {118.123, 11.585}, textColor = {76, 112, 136}, extent = {{-21.877, -6}, {21.877, 6}}, textString = "Explicit", fontName = "Lato", textStyle = {TextStyle.Bold}), Text(origin = {118.123, -11.585}, textColor = {76, 112, 136}, extent = {{-21.877, -6}, {21.877, 6}}, textString = "Generic", fontName = "Lato", textStyle = {TextStyle.Bold}), Line(origin = {46.667, 0}, points = {{33.333, 0}, {93.333, 0}, {93.333, 0}}, color = {76, 112, 136}, thickness = 1), Bitmap(origin = {30.605, 1.418}, extent = {{20.605, -16.418}, {-20.605, 16.418}}, fileName = "modelica://BusinessSimulation/Resources/Images/Examples/LotkaVolterraSystems/Fox.svg"), Bitmap(origin = {-50, 1.507}, extent = {{-16.933, -13.493}, {16.933, 13.493}}, fileName = "modelica://BusinessSimulation/Resources/Images/Examples/LotkaVolterraSystems/Rabbit.svg"), Line(origin = {-158.333, 0}, points = {{18.333, 0}, {78.333, 0}}, color = {76, 112, 136}, thickness = 1), Text(origin = {0, 55}, textColor = {255, 0, 0}, extent = {{-140, -3}, {140, 3}}, textString = "1 s === 1 y", fontName = "Lato")}),
