...
model HealTheWorld "Causal loop model of world dynamics"
  ...
  parameter Time campaignStart(displayUnit = "yrCal") = 31556952 "Start time for the intervention" annotation(Dialog(enable = withIntervention));
  parameter Time campaignDuration(displayUnit = "yrCal", min = modelSettings.dt) = 94670856 "Duration of the intervention" annotation(Dialog(enable = withIntervention));
  ...
  inner ModelSettings modelSettings(modelDisplayTimeBase = BusinessSimulation.Types.TimeBases.years, modelTimeHorizon(displayUnit = "yrCal") = 315569520, dt(displayUnit = "yrCal") = 7889238, samplingPeriod.displayUnit = "yrCal") annotation(Placement(visible = true, transformation(origin = {-110, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
protected
  ...
  CausalLoop.InputControl campaign(startTime(displayUnit = "yrCal") = campaignStart, duration(displayUnit = "yrCal") = campaignDuration, initialInput = 1.0, finalInput = campaignTarget) if withIntervention "Awareness campain as 'control'" annotation(Placement(visible = true, transformation(origin = {-65, 55}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  CausalLoop.ExponentialChange p1(rate(displayUnit = "1/yrCal") = 3.16887385068114e-10, hasRateOutput = false, redeclare replaceable type OutputType = Rate) "Exponential growth of the population" annotation(Placement(visible = true, transformation(origin = {10, -45}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
