...
model ManagingEmployment "Human resource planning"
  ...
  Converters.ConstantConverter gainingExperienceRate(redeclare type OutputType = BusinessSimulation.Units.Ratio, value = 1)  "Gaining experience in units 1s per 1s" annotation(
    Placement(transformation(origin = {-70, -75}, extent = {{-10, -10}, {10, 10}})));
protected
...
equation
  ...
  connect(recruitingPolicy.y, hiring.u) annotation(
    Line(visible = true, origin = {-39.667, 20}, points = {{-9.333, 10}, {4.667, 10}, {4.667, -20}}, color = {1, 37, 163}));
  connect(workforce.y_stockInfo, expertise.u_stockInfo) annotation(
    Line(visible = true, origin = {19.333, -14.933}, points = {{-1.333, 15.333}, {-1.333, 19.933}, {10.667, 19.933}, {10.667, -15.067}, {-9.333, -15.067}, {-9.333, -25.067}}, color = {128, 0, 128}));
  connect(gainingExperience.massPort, expertise.inflow) annotation(
    Line(visible = true, origin = {-10, -50}, points = {{-10, 0}, {10, 0}}, color = {128, 0, 128}));
  connect(workforce.outflow, attrition.portA) annotation(
    Line(visible = true, origin = {30, -10}, points = {{-10, 0}, {10, 0}}, color = {255, 0, 0}));
  connect(attrition.portB, cloud1.massPort) annotation(
    Line(visible = true, origin = {70, -10}, points = {{-10, 0}, {10, 0}}, color = {128, 0, 128}));
  connect(employmentPeriod.y, workforce.u) annotation(
    Line(visible = true, origin = {14.667, 13.333}, points = {{19.333, 6.667}, {-9.667, 6.667}, {-9.667, -13.333}}, color = {1, 37, 163}));
  connect(attrition.y, perceivedAttrition.u) annotation(
    Line(visible = true, origin = {43.121, 40.133}, points = {{11.879, -39.733}, {11.879, 19.867}, {-23.758, 19.867}}, color = {1, 37, 163}));
  connect(perceivedAttrition.y, recruitingPolicy.u_outflow) annotation(
    Line(visible = true, origin = {-36.667, 53.667}, points = {{36.667, 6.333}, {-18.333, 6.333}, {-18.333, -12.667}}, color = {1, 37, 163}));
  connect(workforce.y2, recruitingPolicy.u_current) annotation(
  ...
  connect(desiredWorkforce.y, modelOutput.desiredWorkforce) annotation(
    Line(visible = true, origin = {-37.569, -2.5}, points = {{-72.707, 32.5}, {-42.431, 32.5}, {-42.431, -32.5}, {157.569, -32.5}}, color = {192, 192, 192}));
  connect(expertise.y, modelOutput.experience) annotation(
