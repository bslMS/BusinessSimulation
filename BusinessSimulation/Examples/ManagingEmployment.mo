...
model ManagingEmployment "Human resource planning"
  ...
  inner ModelSettings modelSettings(lookupDataFileURI = "modelica://BusinessSimulation/Resources/SampleTable1D.txt", modelDisplayTimeBase = BusinessSimulation.Types.TimeBases.years, modelTimeHorizon(displayUnit = "yrCal") = 315569520, dt(displayUnit = "yrCal") = 7889238) annotation(Placement(visible = true, transformation(origin = {-130, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  expandable connector ModelOutput "The model's main output"
    ...
    Time_years experience "Average workexperience in the workforce";
  end ModelOutput;
protected
  ...
  MoleculesOfStructure.Policy.FirstOrderStockAdjustment recruitingPolicy(adjTime(displayUnit = "yrCal") = 15778476) "How many people are needed?" annotation(Placement(visible = true, transformation(origin = {-60, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Stocks.HinesCoflow expertise(initialValue = 252455616, hasStockInfoOutput = false, redeclare replaceable type OutputType = Time_years) "Average erperience of employees measured in years" annotation(Placement(visible = true, transformation(origin = {10, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  SourcesOrSinks.Growth gainingExperience(hasConstantRate = false, rate.displayUnit = "1/yrCal") "Gaining experience on the job" annotation(Placement(visible = true, transformation(origin = {-30, -50}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
  Converters.ConstantConverterRate gainingExperienceRate(value = 31556952, timeBaseString = "year", redeclare replaceable type ValueType = Time_years) "Rate of gaining experience" annotation(Placement(visible = true, transformation(origin = {-70, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Converters.ConstantConverterTime employmentPeriod(value = 157784760, redeclare replaceable type OutputType = Time_years) "Average length of employment" annotation(Placement(visible = true, transformation(origin = {40, 20}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Converters.DiscreteDelay.Smooth perceivedAttrition(delayTime(displayUnit = "yrCal") = 31556952, init = BusinessSimulation.Types.InitializationOptions.SteadyState, redeclare replaceable type OutputType = LaborGrowthRate) "The rate of leaving the company reported with delay" annotation(Placement(visible = true, transformation(origin = {10, 60}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  InformationSources.RampInput experienceNewEmployees(redeclare replaceable type OutputType = Time_years, offset = 157784760, startTime(displayUnit = "yrCal") = 31556952, height = -94670856, duration(displayUnit = "yrCal") = 126227808) "The prior experience of new employees given in years" annotation(Placement(visible = true, transformation(origin = {-117.141, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  InformationSources.RampInput desiredWorkforce(offset = 750, startTime(displayUnit = "yrCal") = 31556952, height = 450, duration(displayUnit = "yrCal") = 189341712, redeclare replaceable type OutputType = Labor) "The desired Workforce given in FTE" annotation(Placement(visible = true, transformation(origin = {-118.276, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(desiredWorkforce.y, recruitingPolicy.u_reference) annotation(Line(visible = true, origin = {-90.638, 30}, points = {{-19.638, 0}, {19.638, 0}}, color = {1, 37, 163}));
  ...
  annotation(experiment(StartTime = 0, StopTime = 315569520, __Wolfram_DisplayTimeUnit = "yrCal"), __Wolfram, Diagram(coordinateSystem(extent = {{-148.5, -105}, {148.5, 105}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5}), graphics = {Text(visible = true, origin = {0, 80}, textColor = {76, 112, 136}, extent = {{-140, -6}, {140, 6}}, textString = "Managing Employment", fontName = "Lato")}), Documentation(info = "<html>
