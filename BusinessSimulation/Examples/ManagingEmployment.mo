...
protected
  ...
  Stocks.DelayN workforce(hasConstantDelayTime = false, hasStockInfoOutput = true, n = 3, redeclare replaceable type OutputType = Units.Labor, initialValue = 750) "Workforce measured in full-time equivalents (FTE)" annotation(Placement(visible = true, transformation(origin = {10, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Stocks.HinesCoflow expertise(initialValue = 252288000, hasStockInfoOutput = false, redeclare replaceable type OutputType = Units.Time_years) "Average erperience of employees measured in years" annotation(Placement(visible = true, transformation(origin = {10, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Converters.ConstantConverterRate gainingExperienceRate(value = 31536000, timeBaseString = "year", redeclare replaceable type ValueType = Units.Time_years) "Rate of gaining experience" annotation(Placement(visible = true, transformation(origin = {-70, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  annotation(__Wolfram, Diagram(coordinateSystem(extent = {{-148.5, -105}, {148.5, 105}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5}), graphics = {Text(visible = true, origin = {0, 80}, textColor = {76, 112, 136}, extent = {{-140, -6}, {140, 6}}, textString = "Managing Employment", fontName = "Lato Black")}), Documentation(info = "<html>
