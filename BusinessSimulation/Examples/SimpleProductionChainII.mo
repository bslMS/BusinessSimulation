...
protected
  ...
  MoleculesOfStructure.Policy.FirstOrderStockAdjustment productionRate(adjTime(displayUnit = "mo") = 2628000, hasConstantAdjTime = true) annotation(Placement(visible = true, transformation(origin = {-90, -50}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
...
equation
  ...
  connect(shippingRate.y, shipping.u) annotation(Line(visible = true, origin = {-15, 7.365}, points = {{0, 7.365}, {0, -7.365}}, color = {1, 37, 163}));
