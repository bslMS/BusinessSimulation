...
model StockPortSensor_Control "Rate of flow information from stock ports"
  ...
  Interfaces.Connectors.BooleanOutput stopInflow "Report the signal received at the flow port side" annotation(Placement(visible = true, transformation(origin = {160, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-20, 30}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Interfaces.Connectors.BooleanOutput stopOutflow "Report the signal received at the flow port side" annotation(Placement(visible = true, transformation(origin = {160, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {20, 30}, extent = {{10, -10}, {-10, 10}}, rotation = -540)));
initial equation
