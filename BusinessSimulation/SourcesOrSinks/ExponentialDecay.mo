...
model ExponentialDecay "A stock is drained at a rate proportional to its content"
  ...
  parameter Time residenceTime(min = 0, unit = "s") = 1 "Constant time of average residence (optional) (decaying.residenceTime)" annotation(Dialog(enable = hasConstantResidenceTime));
protected
