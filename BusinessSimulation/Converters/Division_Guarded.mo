...
<h4>See also</h4>
<p><a href=\"modelica://BusinessSimulation.Converters.Division\">Division</a></p></html>", revisions = ""), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Line(visible = true, rotation = -45, points = {{20, 20}, {-20, -20}}, color = {0, 0, 128}, thickness = 4), Line(visible = true, origin = {-60.109, 49.884}, rotation = -990, points = {{0.116, -0.109}, {0.116, -47.528}, {-19.884, -47.528}}, color = {0, 0, 128}, thickness = 3), Line(visible = true, origin = {-33.755, -50}, rotation = -270, points = {{0, 26.245}, {0, -43.755}, {15.751, -43.755}}, color = {255, 0, 0}, thickness = 3), Text(visible = true, origin = {0, 15}, textColor = {0, 0, 128}, extent = {{-30, -12}, {30, 12}}, textString = "Nom", fontName = "Lato Black", textStyle = {TextStyle.Bold}), Text(visible = true, origin = {0.75, -15}, textColor = {255, 0, 0}, extent = {{-29.25, -12}, {29.25, 12}}, textString = "Den", fontName = "Lato Black", textStyle = {TextStyle.Bold})}), Diagram(coordinateSystem(extent = {{-148.5, -105}, {148.5, 105}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})));
