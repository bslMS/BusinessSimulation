...
</html>"), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Text(visible = true, origin = {9, 0}, textColor = {0, 0, 128}, extent = {{-40.484, -12}, {40.484, 12}}, textString = "THLD", fontName = "Lato", textStyle = {TextStyle.Bold}), Text(visible = true, origin = {-30, 0}, textColor = {190, 52, 178}, extent = {{-36.812, -20}, {36.812, 20}}, textString = ">", fontName = "Lato", textStyle = {TextStyle.Bold}), Text(visible = true, origin = {0, -30}, textColor = {0, 0, 128}, extent = {{-31.111, -6}, {31.111, 6}}, textString = "%threshold", fontName = "Lato", textStyle = {TextStyle.Bold})}), Diagram(coordinateSystem(extent = {{-148.5, -105}, {148.5, 105}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})));
end Threshold;
