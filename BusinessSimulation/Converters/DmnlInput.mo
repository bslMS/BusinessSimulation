...
block DmnlInput "Input u will be stated as dimensionless fraction with regard to a reference value"
  ...
  parameter Real referenceValue "Reference value, so that input is represented as a dimensionless fraction thereof" annotation(Dialog(enable = hasConstantReference));
...
equation
  ...
  connect(division_yidz.y, y) annotation(Line(visible = true, origin = {83.681, 0}, points = {{-76.319, 0}, {76.319, 0}}, color = {0, 0, 127}));
...
<h4>See also</h4>
<p><a href=\"modelica://BusinessSimulation.Converters.Division_Guarded\">Division_Guarded</a></p></html>", revisions = ""), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Text(visible = true, textColor = {0, 0, 128}, extent = {{-43.326, -12}, {43.326, 12}}, textString = "Dmnl [1]", fontName = "Lato Black", textStyle = {TextStyle.Bold})}), Diagram(coordinateSystem(extent = {{-148.5, -105}, {148.5, 105}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})));
end DmnlInput;
