...
block PerformanceIndicator "Indicator function using fuzzy membership functions"
  ...
  extends Interfaces.PartialConverters.SISO(redeclare final type OutputType = Units.Dimensionless);
...
equation
  y = if invertResult then 1 - Functions.evalmf(u, mft, a = a, b = b, c = c, d = d) else Functions.evalmf(u, mft, a = a, b = b, c = c, d = d);
