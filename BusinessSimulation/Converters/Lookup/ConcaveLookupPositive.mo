...
equation
  ...
  if strict then
    y_c = noEvent(if u_c <= 0 then y0 else y0 + (1 - y0) * u_c ^ s);
  else
...
<li><code>s</code> (slope) should be within the interval (0,1].</li><br>
<li>By default (<code>strict = true</code>) the component will not generate events.</li><br>
</ul>
<h4>See also</h4>
<p><a href=\"modelica://BusinessSimulation.Converters.Lookup.ConcaveLookupNegative\">ConcaveLookupNegative</a>, <a href=\"modelica://BusinessSimulation.Converters.Lookup.ConvexLookupPositive\">ConvexLookupPositive</a>,&nbsp;<a href=\"modelica://BusinessSimulation.Converters.Lookup.ConvexLookupNegative\">ConvexLookupNegative</a></p></html>", revisions = "<html><ul>
