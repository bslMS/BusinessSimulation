...
equation
  ...
  connect(u, proportions.u2) annotation(Line(visible = true, origin = {-58.895, 32.491}, points = {{-86.105, 27.509}, {-21.105, 27.509}, {-21.105, -27.528}, {50.857, -27.528}}, color = {0, 0, 128}));
